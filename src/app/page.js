    ...
    <>
      <div className='w-full h-full p-32'>
        <main className='flex items-center justify-between w-full'>
          <AnimatedImg src={'https://cdn.leonardo.ai/users/9a01fe03-e38d-4147-9504-334e27fe8920/generations/cd0c3a2a-dd03-4a69-84b3-1cc20907273d/DreamShaper_v7_Design_an_animestyle_male_character_with_glasse_3.jpg'} alt="d"/>
          <div className='w-1/2'>
